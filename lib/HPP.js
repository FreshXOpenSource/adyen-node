...
var HPP = function (options) {
  ...
  if (options.test === true) {
    this._url = 'https://test.barclaycardsmartpay.com/hpp/' + this._paymentPage + '.shtml?';
  ...
  this._request = {
    ...
    shopperLocale: options.shopperLocale || null,                                                             // A combination of language code and country code to specify the language used in the session i.e. en_GB.
...
HPP.prototype.generateHash = function () {
  ...
  hmacText = 'currencyCode:merchantAccount:merchantReference:merchantReturnData:paymentAmount:recurringContract:sessionValidity:shipBeforeDate:shopperEmail:shopperReference:skinCode:';

             // 'merchantAccount:merchantReference:merchantReturnData:recurringContract:sessionValidity:shipBeforeDate:shopperEmail:shopperReference:skinCode:';
             // currencyCode:merchantAccount:merchantReference:merchantReturnData:paymentAmount:sessionValidity:shipBeforeDate:shopperEmail:skinCode:GBP:ProjectXWeb:Order123:testSky:10000:2015-12-16T11\:53\:25+00\:00:2015-12-31:customer@domain.com:mOIr3aTu
             // currencyCode:merchantAccount:merchantReference:merchantReturnData:paymentAmount:sessionValidity:shipBeforeDate:shopperEmail:skinCode:GBP:ProjectXWeb:Order123:testSky:10000:2015-12-16T11\:53\:25+00\:00:2015-12-31:customer@domain.com:mOIr3aTu
             // currencyCode:merchantAccount:merchantReference:merchantReturnData:paymentAmount:recurringContract:sessionValidity:shipBeforeDate:shopperEmail:shopperReference:skinCode:GBP:ProjectXWeb:12aUniqueOrderID34:12aUniqueUserID34:5:RECURRING:2016-03-09T10\:41\:13+00\:00:2015-12-31:12aUniqueUserID34@domain.com:12aUniqueUserID34:mOIr3aTu
  // Required fields
  hmacText +=
    this._request.currencyCode + ':' +
    this._request.merchantAccount + ':' +
    this._request.merchantReference + ':' +
    this._request.merchantReturnData + ':' +
    this._request.paymentAmount + ':' +
    this._request.recurringContract + ':' +
    this._request.sessionValidity.replace(/:/g, '\\:') + ':' +
  ...
  hmac = crypto.createHmac('sha256', hex2a(this._HMACKey));
